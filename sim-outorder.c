 ...
 * cache miss handlers
 */
    // COMPUTER DESIGN: This is the function which is called when there is a 
    // miss in the L1.  For now, it calls the L2, but you need to have it call
    // the victim cache.  The victim cache would then call the L2 if there is a miss.
	      ...
	      tick_t now)		/* time of access */
{
  ...
  if (cache_dl2)
    ...
    // COMPUTER DESIGN: This is the function which is called when there is a 
    // miss in the L2.  It calls the memory. 
...
"             table sizes.\n"
  ...
  opt_reg_string(odb, "-bpred",
		 "branch predictor type {nottaken|taken|perfect|bimod|2lev|comb|lab4}",
